...
public class OfficesController {
    ...
    public String createOffice(String officeCode,String city,
    ...
    public void deleteOffices(String officeCode){

        officesDaoImple.deleteOffice(officeCode);
    }
     public String updateOffices(String officeCode,String city,
            String phone,String addressLine1,String addressLine2,
            String state,String country,String postalCode,String territory){
